...
public class LiftTrigger : MonoBehaviour
{
		...
		private SceneFadeInAndOut sceneFadeInOut;
		...
		void Awake ()
		{
				...
				sceneFadeInOut = GameObject.FindGameObjectWithTag (Tags.fader).GetComponent<SceneFadeInAndOut> ();
		...
		void LiftActivation ()
		{
				...
				if (timer >= timeToLiftStart) {
						playerAnimator.SetFloat (hash.speedFloat, 0f);
